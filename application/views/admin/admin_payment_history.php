  ...
  <div class="row">
    <div class="col-xs-12">
            ...
            >
               ...
               <thead>
                 <tr>
                     ...
                     <!-- <th field="email" sortable="true">User Email</th>-->
                     <th field="paypal_email" sortable="true"><?php echo $this->lang->line('Paypal Email'); ?></th>                        
                     <!-- <th field="mobile" sortable="true">User Mobile</th>-->
                     <th field="paid_amount" sortable="true" ><?php echo $this->lang->line('Paid Amount'); ?> (<?php echo $system_currency; ?>)</th>
                     <th field="transaction_id" sortable="true" ><?php echo $this->lang->line('Transaction ID'); ?></th>
       ...
       <div id="tb" style="padding:3px">
            ...
            <h4 style="color:olive"><?php echo $this->lang->line('Total Paid Amount'); ?> : <?php echo $total_paid_amount." ".$system_currency; ?></h4> 
