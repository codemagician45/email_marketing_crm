		...
		<tr  <?php if($num_row % 2 == 1){?>class="erow"<?php }?>>
			...
			<td align="left" width='20%'>
				<div class='tools'>					
					...
					?>
							<a href="<?php echo $action_url; ?>" target="<?php echo $action->target; ?>" title="<?php echo $action->label?>" class="btn btn-outline-primary <?php echo $action->css_class;?> crud-action" title="<?php echo $action->label?>"><?php 
