			...
			{ 
				...
				{ ?>
					<div class="tDiv2 <?php if(array_key_exists('set_custom_link_pull_right',$set_custom_link[$i]) && $set_custom_link[$i]['set_custom_link_pull_right']==true) echo 'pull-right'; ?>">
			        	<a href="<?php echo $set_custom_link[$i]['set_custom_link_url'];?>" <?php if(isset($set_custom_link[$i]['set_custom_link_target'])) echo "target='_blank'"; ?> title="<?php echo $set_custom_link[$i]['set_custom_link_hover'];?>" class="<?php echo $set_custom_link[$i]['set_custom_link_btn_class'];?>">
